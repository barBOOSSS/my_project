package by.pleshkov.database.config;
...
@ComponentScan("by.pleshkov.database")
@PropertySource({"classpath:datasource.properties", "classpath:hibernate.properties"})
@EnableTransactionManagement
@Configuration
@EnableJpaRepositories(basePackages = "by.pleshkov.database.repository")
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Properties hibernateProperties) {
        ...
        entityManagerFactory.setPackagesToScan("by.pleshkov.database.entity");
